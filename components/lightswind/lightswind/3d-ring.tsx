...
export function Draggable3DCardRing({
  cards,
  width = 300,
  perspective = 2000,
  imageDistance = 500,
  ...
  const angle = useMemo(() => 360 / cards.length, [cards.length]);
  ...
  useEffect(() => {
    ...
    return () => unsubscribe();
  }, [rotationY, cards.length, imageDistance, currentScale, angle]);
...
export default Draggable3DCardRing;
